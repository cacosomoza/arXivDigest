# arXiv Digest — Technical Documentation

This document explains the inner mechanisms of the arXiv Digest pipeline and provides guidance for tuning parameters to your research needs. For installation and usage instructions, see [README.md](README.md).
